...
public interface FeatureManager extends Manager {
    ...
    /**
     * Creates and starts the specified {@link Feature} whose {@code FeatureCompatFragment}s are hosted by
    ...
    /**
     * Starts the given {@link Feature} whose {@code FeatureCompatFragment}s are hosted by
     * the given {@link FeatureContainer}.
     *
     * @param featureContainer A {@link FeatureContainer}.
