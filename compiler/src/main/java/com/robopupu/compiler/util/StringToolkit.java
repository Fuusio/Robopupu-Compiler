...
public class StringToolkit {
     ...
     */
    public static String getClassName(final String qualifiedName) {
    ...
    /**
     * Extracts the package name from the given fully qualified class name.
     * @param qualifiedName The fully qualified class name.
     * @return The package name as {@link String}.
     */
